...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Win10-GP76\Documents\Coding\ajay-app'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('ajay-app' == '') {
...
alias deactivate = source 'C:\Users\Win10-GP76\Documents\Coding\ajay-app\Scripts\deactivate.nu'
